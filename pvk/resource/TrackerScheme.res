...
Scheme
{
	...
	{
		// base colors
		"BaseText"			"211 211 211 255"	// used in text windows, lists
		"BrightBaseText"	"255 255 255 255"	// brightest text
		"SelectedText"		"255 255 255 255"	// selected text
		"DimBaseText"		"160 160 160 255"	// dim base text
		"LabelDimText"		"160 160 160 255"	// used for info text
		"ControlText"		"210 210 210 255"	// used in all text controls
		"BrightControlText"	"196 196 196 255"	// use for selected controls
		"DisabledText1"		"127 118 111 255"	// disabled text
		"DisabledText2"		"46 46 46 255"		// overlay color for disabled text (to give that inset look)
		"DimListText"		"33 33 33 255"	// offline friends, unsubscribed games, etc.

		// background colors
		"ControlBG"			"85 51 0 255"		// background color of controls
		"ControlDarkBG"		"62 37 0 255"		// darker background color; used for background of scrollbars
		"WindowBG"			"62 37 0 255"		// background color of text edit panes (chat, text entries, etc.)
		...
		"ListBG"			"66 66 66 255"		// background of server browser, buddy list, etc.
		...
		// border colors
		"BorderBright"		"149 89 0 255"	// the lit side of a control
